...
public class BoardControllerTests {
	...
	public void testList() throws Exception {
		log.info(mokMvc.perform(MockMvcRequestBuilders.get("/board/list")
														.param("pageNum", "2")
														.param("amount", "50"))
						.andReturn()
						.getModelAndView()
	...
	public void testGet() throws Exception {
		...
		log.info(mokMvc.perform(MockMvcRequestBuilders.get("/board/get").param("bno", "1"))
						.andReturn()
						.getModelAndView()
						.getModelMap());
	}
	...
	public void testRemove() throws Exception {
		...
		String resultPage = mokMvc.perform(MockMvcRequestBuilders.post("/board/remove").param("bno", "41"))
									.andReturn().getModelAndView().getViewName();
